...
)
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("inpgain", "inpgain", juce::NormalisableRange<float>(0.0f, 1.0f, 0.001f), 400.f));

    layout.add(std::make_unique<juce::AudioParameterInt>("Channel", "Channel", 0, 16, 1));
